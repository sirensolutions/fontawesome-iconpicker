...
(function(a) {
    ...
    c.defaultOptions = a.extend(c.defaultOptions, {
        icons: [ {
            ...
            searchTerms: [ "graph", "analytics", "line-chart" ]
        }, {
            ...
            title: "fas fa-gavel",
            searchTerms: [ "judge", "lawyer", "opinion" ]
        }, {
            title: "far fa-gavel",
            searchTerms: [ "judge", "lawyer", "opinion" ]
        }, {
            ...
            searchTerms: [ "write", "edit", "update", "pencil" ]
        }, {
