...
var defaults = {
    ...
    replaceOriginalIcons: false //defaults to false, but can be updated as true when the icon picker is initialized. If true, replaces the original font awesome icons with the custom icons else appends to them
